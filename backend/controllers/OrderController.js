...
const saveOrder=(async(req,res)=>{
    ...
    const date=new Date();
    const {product,price,qty,total,status,Name,phoneNo,Email,Address}=req.body;
    
    const newOrder=new Order({OrderNo,date,product,price,qty,total,status,Name,phoneNo,Email,Address});
...
export {saveOrder,getOrders,updateOrder,deleteOrder,getOne};